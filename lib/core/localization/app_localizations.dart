...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = <String, Map<String, String>>{
    'en': <String, String>{
      ...
      'login.phonePrompt': 'Your phone number',
      'login.phoneHint': 'Phone number',
      'login.validation.phone': 'Please enter your phone number.',
      ...
      'addCatch.title': 'Share a catch',
      'addCatch.chooseImage': 'Add a photo',
      'addCatch.takePhoto': 'Take a photo',
      'addCatch.pickGallery': 'Choose from library',
      'addCatch.speciesLabel': 'Species',
      'addCatch.weightLabel': 'Weight (kg)',
      'addCatch.lengthLabel': 'Length (cm)',
      'addCatch.locationLabel': 'Fishing spot',
      'addCatch.descriptionLabel': 'Notes',
      'addCatch.submit': 'Publish catch',
      'addCatch.validation.image': 'Add a photo to share your catch.',
      'addCatch.validation.species': 'Please enter the species.',
      'addCatch.validation.location': 'Please enter the fishing spot.',
    },
    'fr': <String, String>{
      ...
      'login.phonePrompt': 'Ton numero de telephone',
      'login.phoneHint': 'Numero de telephone',
      'login.validation.phone': 'Merci d\'entrer ton numero.',
      ...
      'home.profile.phoneLabel': 'Telephone',
      ...
      'addCatch.title': 'Partager une prise',
      'addCatch.chooseImage': 'Ajoute une photo',
      'addCatch.takePhoto': 'Prendre une photo',
      'addCatch.pickGallery': 'Choisir dans la galerie',
      'addCatch.speciesLabel': 'Espece',
      'addCatch.weightLabel': 'Poids (kg)',
      'addCatch.lengthLabel': 'Taille (cm)',
      'addCatch.locationLabel': 'Lieu de peche',
      'addCatch.descriptionLabel': 'Notes',
      'addCatch.submit': 'Publier la prise',
      'addCatch.validation.image': 'Ajoute une photo pour partager ta prise.',
      'addCatch.validation.species': 'Indique l\'espece.',
      'addCatch.validation.location': 'Indique le lieu de peche.',
    },
  };
